# Run PLAS on images of different sizes and measure runtime
# Figure 9 in https://arxiv.org/abs/2312.13299 (Self-Organizing Gaussian Grids paper) created from this script
